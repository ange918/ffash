...
export default function PanierPage() {
  const { items, removeFromCart, updateQuantite, clearCart } = useCartStore();
    ...
    <div className="px-4 sm:px-6 py-8 sm:py-12" style={{ backgroundColor: "#FDFAF8", minHeight: "100vh" }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8 sm:mb-10">
          <h1 style={{ fontFamily: "var(--font-unbounded)", fontWeight: 300, color: "#3A2A35", fontSize: "clamp(1.6rem,4vw,2.8rem)" }}>
            Mon Panier
          </h1>
          {totalArticles > 0 && (
        ...
        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16 sm:py-24 gap-6">
            ...
            <p style={{ fontFamily: "var(--font-unbounded)", fontWeight: 300, color: "#3A2A35", fontSize: "1.1rem" }}>Votre panier est vide</p>
            <p className="text-center" style={{ fontFamily: "var(--font-montserrat)", color: "#7A6070", fontSize: "0.9rem" }}>Découvrez nos produits et ajoutez-les à votre panier</p>
            <Link
              href="/catalogue"
          ...
          <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
            ...
            <div className="flex-1 flex flex-col gap-3 sm:gap-4">
              {items.map((item) => (
                <div
                  ...
                  style={{ backgroundColor: "white", borderRadius: "12px", padding: "1rem 1.2rem", boxShadow: "0 2px 12px rgba(232,115,154,0.07)" }}
                >
                  {/* Mini image */}
                  <div className="flex items-center justify-center flex-shrink-0" style={{ width: "64px", height: "64px", backgroundColor: "#FDE8EF", borderRadius: "10px" }}>
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="truncate" style={{ fontFamily: "var(--font-unbounded)", fontWeight: 400, color: "#3A2A35", fontSize: "clamp(0.78rem,2vw,0.95rem)", lineHeight: 1.3 }}>
                      {item.product.nom}
                    </h3>
                    <p style={{ fontFamily: "var(--font-montserrat)", color: "#7A6070", fontSize: "0.72rem", marginTop: "0.15rem" }}>
                      {item.product.categorie}
                    </p>
                    <p style={{ fontFamily: "var(--font-montserrat)", fontWeight: 500, color: "#C94F78", fontSize: "0.82rem", marginTop: "0.2rem" }}>
                      {item.product.prix.toLocaleString("fr-FR")} FCFA
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                    <button
                      ...
                      style={{ width: "28px", height: "28px", borderRadius: "6px", backgroundColor: "#FDE8EF", border: "none", cursor: "pointer", fontFamily: "var(--font-montserrat)", fontWeight: 600, color: "#C94F78", fontSize: "1rem" }}
                    >−</button>
                    <span style={{ fontFamily: "var(--font-montserrat)", fontWeight: 600, color: "#3A2A35", minWidth: "22px", textAlign: "center", fontSize: "0.9rem" }}>
                      {item.quantite}
                    </span>
                    <button
                      onClick={() => updateQuantite(item.product.id, item.quantite + 1)}
                  ...
                  <div className="flex-shrink-0 text-right hidden sm:block">
                    <p style={{ fontFamily: "var(--font-unbounded)", fontWeight: 600, color: "#C94F78", fontSize: "0.95rem" }}>
                  ...
                  <button
                    ...
                    style={{ background: "none", border: "none", cursor: "pointer", color: "#E8739A", flexShrink: 0, padding: "4px" }}
            ...
            <div className="lg:w-80 flex-shrink-0">
              <div className="lg:sticky lg:top-24" style={{ backgroundColor: "white", borderRadius: "16px", padding: "1.5rem sm:2rem", boxShadow: "0 4px 20px rgba(232,115,154,0.1)" }}>
